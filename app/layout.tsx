      ...
      <li>
        <a>
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-5 h-5 dark:stroke-accent stroke-2"
          >
            <path
              strokeLinecap="round"
        ...
        <div className="navbar">
          <div className="flex-1 gap-2">
            <div className="w-8 h-8">
              <svg viewBox="0 0 77 72" className="fill-black dark:fill-white">
            ...
            <Link
              href="/"
              className="text-xl hidden sm:block font-mono dark:text-white font-bold"
            >
              DaisyUI Templates
            </Link>
            <Link
              href="/"
              className="text-2xl sm:hidden font-mono dark:text-white font-bold"
            >
              DT
            </Link>
          </div>
          <div className="flex-none">
            ...
            <ul className="menu menu-horizontal px-1 font-semibold dark:text-white hidden md:inline-flex">
              <NavbarMenu />
            </ul>
          </div>
        </div>
        {children}
        <footer className="footer items-center justify-center p-4 bg-gray-800 bg-opacity-10 text-neutral dark:text-neutral-content">
